  ...
  <section class="m-table-comb">
    ...
    <section class="table-filter">
      ...
      <el-form :model="searchModelDataBase" label-width="120px" size="small" style="font-size: 14px;">
        ...
        <el-button type="primary" @click="search" v-if="!isOpenAdvancedSearch"  v-show="!isNotBaseSearch" style="margin-left: 10px;">查询</el-button>
    ...
    <!--分页-->
    <section class="table-paging" v-if="showPagination">
      <el-pagination
...
export default {
  ...
  methods: {
    ...
    getPageVo(pageIndex){
      ...
      // 高级搜索
      if (this.isOpenAdvancedSearch || this.isSearchAll) {
